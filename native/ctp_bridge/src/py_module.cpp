...
std::string get_str(const py::dict &d, const char *key,
...
public:
  ...
  void OnRspQryTradingAccount(CThostFtdcTradingAccountField *pStruct,
                              ...
                              bool bIsLast) override;
  void
  OnRspQryInvestorPositionDetail(CThostFtdcInvestorPositionDetailField *pStruct,
                                 CThostFtdcRspInfoField *pRspInfo,
                                 int nRequestID, bool bIsLast) override;
  void OnRspQryInstrument(CThostFtdcInstrumentField *pStruct,
                          CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                          bool bIsLast) override;
  void OnRspQryInstrumentCommissionRate(
      CThostFtdcInstrumentCommissionRateField *pStruct,
      CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) override;
  void
  OnRspQryInstrumentMarginRate(CThostFtdcInstrumentMarginRateField *pStruct,
                               CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                               bool bIsLast) override;
  void OnRspQryOrder(CThostFtdcOrderField *pStruct,
                     CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                     bool bIsLast) override;
  void OnRspQryTrade(CThostFtdcTradeField *pStruct,
                     CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                     bool bIsLast) override;
  void OnRspSettlementInfoConfirm(
      CThostFtdcSettlementInfoConfirmField *pSettlementInfoConfirm,
      CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) override;
  void OnRspOrderInsert(CThostFtdcInputOrderField *pStruct,
                        CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                        bool bIsLast) override;
  void OnRspOrderAction(CThostFtdcInputOrderActionField *pStruct,
                        CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                        bool bIsLast) override;
...
public:
  ...
  void configure(const py::dict &cfg) {
    ...
    request_timeout_ms_ =
        get_int(cfg, "request_timeout_ms", request_timeout_ms_);
  }
  ...
  void start() {
    ...
    if (trade_front_.empty() || market_front_.empty() || broker_id_.empty() ||
        investor_id_.empty() || password_.empty() || appid_.empty() ||
        authcode_.empty() || userinfo_.empty()) {
  ...
  py::list request(const std::string &req_name, const py::object &payload) {
    ...
    bool is_market_req = (req_name == "SubscribeMarketData" ||
                          req_name == "UnSubscribeMarketData");
  ...
  void on_trade_login_rsp(CThostFtdcRspUserLoginField *pRspUserLogin,
                          CThostFtdcRspInfoField *pRspInfo, int nRequestID) {
    py::gil_scoped_acquire gil;
    py::dict row;
    if (pRspInfo && pRspInfo->ErrorID != 0) {
  ...
  void
  on_rsp_settlement_info_confirm(CThostFtdcSettlementInfoConfirmField *pStruct,
                                 CThostFtdcRspInfoField *pRspInfo,
  ...
  void on_rsp_error(int request_id, int error_id,
  ...
  void on_rsp_trading_account(CThostFtdcTradingAccountField *pStruct,
                              CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                              bool bIsLast) {
    py::gil_scoped_acquire gil;
    py::dict row;
  ...
  void on_rsp_investor_position_detail(
      CThostFtdcInvestorPositionDetailField *pStruct,
  ...
  void on_rsp_instrument(CThostFtdcInstrumentField *pStruct,
                         CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                         bool bIsLast) {
    py::gil_scoped_acquire gil;
    py::dict row;
  ...
  void on_rsp_instrument_commission_rate(
      CThostFtdcInstrumentCommissionRateField *pStruct,
      CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
    py::gil_scoped_acquire gil;
    py::dict row;
  ...
  void
  on_rsp_instrument_margin_rate(CThostFtdcInstrumentMarginRateField *pStruct,
                                CThostFtdcRspInfoField *pRspInfo,
                                int nRequestID, bool bIsLast) {
    py::gil_scoped_acquire gil;
    py::dict row;
  ...
  void on_rsp_qry_order(CThostFtdcOrderField *pStruct,
                        CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                        bool bIsLast) {
    py::gil_scoped_acquire gil;
    py::dict row;
  ...
  void on_rsp_qry_trade(CThostFtdcTradeField *pStruct,
                        CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                        bool bIsLast) {
    py::gil_scoped_acquire gil;
    py::dict row;
  ...
  void on_rsp_order_insert(CThostFtdcInputOrderField *pStruct,
                           CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                           bool bIsLast) {
    py::gil_scoped_acquire gil;
    py::dict row;
  ...
  void on_rsp_order_action(CThostFtdcInputOrderActionField *pStruct,
                           CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                           bool bIsLast) {
    py::gil_scoped_acquire gil;
    py::dict row;
  ...
  void
  on_rsp_sub_market_data(CThostFtdcSpecificInstrumentField *pSpecificInstrument,
                         CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                         bool bIsLast, bool un_sub) {
    py::gil_scoped_acquire gil;
    py::dict row;
    if (pRspInfo && pRspInfo->ErrorID != 0) {
      row["ErrorID"] = pRspInfo->ErrorID;
...
private:
  ...
  int dispatch_request(const std::string &req_name, int request_id,
    ...
    if (req_name == "SubscribeMarketData") {
      ...
      return md_api_->SubscribeMarketData(ptrs.data(),
    ...
    if (req_name == "UnSubscribeMarketData") {
      ...
      return md_api_->UnSubscribeMarketData(ptrs.data(),
                                            static_cast<int>(ptrs.size()));
    }
    if (req_name == "ReqOrderInsert") {
...
void TraderSpi::OnFrontDisconnected(int nReason) {
  owner_->on_trade_front_disconnected(nReason);
}

void TraderSpi::OnRspAuthenticate(
    CThostFtdcRspAuthenticateField * /*pRspAuthenticateField*/,
    CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool /*bIsLast*/) {
  owner_->on_trade_auth_rsp(pRspInfo, nRequestID);
}

void TraderSpi::OnRspUserLogin(CThostFtdcRspUserLoginField *pRspUserLogin,
                               CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                               bool /*bIsLast*/) {
  owner_->on_trade_login_rsp(pRspUserLogin, pRspInfo, nRequestID);
}
...
void TraderSpi::OnRspQryTradingAccount(CThostFtdcTradingAccountField *pStruct,
                                       CThostFtdcRspInfoField *pRspInfo,
                                       int nRequestID, bool bIsLast) {
  owner_->on_rsp_trading_account(pStruct, pRspInfo, nRequestID, bIsLast);
}

void TraderSpi::OnRspQryInvestorPositionDetail(
    CThostFtdcInvestorPositionDetailField *pStruct,
    CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  owner_->on_rsp_investor_position_detail(pStruct, pRspInfo, nRequestID,
                                          bIsLast);
}

void TraderSpi::OnRspQryInstrument(CThostFtdcInstrumentField *pStruct,
                                   CThostFtdcRspInfoField *pRspInfo,
                                   int nRequestID, bool bIsLast) {
  owner_->on_rsp_instrument(pStruct, pRspInfo, nRequestID, bIsLast);
}

void TraderSpi::OnRspQryInstrumentCommissionRate(
    CThostFtdcInstrumentCommissionRateField *pStruct,
    CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  owner_->on_rsp_instrument_commission_rate(pStruct, pRspInfo, nRequestID,
                                            bIsLast);
}

void TraderSpi::OnRspQryInstrumentMarginRate(
    CThostFtdcInstrumentMarginRateField *pStruct,
    CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  owner_->on_rsp_instrument_margin_rate(pStruct, pRspInfo, nRequestID, bIsLast);
}

void TraderSpi::OnRspQryOrder(CThostFtdcOrderField *pStruct,
                              CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                              bool bIsLast) {
  owner_->on_rsp_qry_order(pStruct, pRspInfo, nRequestID, bIsLast);
}

void TraderSpi::OnRspQryTrade(CThostFtdcTradeField *pStruct,
                              CThostFtdcRspInfoField *pRspInfo, int nRequestID,
                              bool bIsLast) {
  owner_->on_rsp_qry_trade(pStruct, pRspInfo, nRequestID, bIsLast);
}

void TraderSpi::OnRspSettlementInfoConfirm(
    CThostFtdcSettlementInfoConfirmField *pSettlementInfoConfirm,
    CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  owner_->on_rsp_settlement_info_confirm(pSettlementInfoConfirm, pRspInfo,
                                         nRequestID, bIsLast);
}

void TraderSpi::OnRspOrderInsert(CThostFtdcInputOrderField *pStruct,
                                 CThostFtdcRspInfoField *pRspInfo,
                                 int nRequestID, bool bIsLast) {
  owner_->on_rsp_order_insert(pStruct, pRspInfo, nRequestID, bIsLast);
}

void TraderSpi::OnRspOrderAction(CThostFtdcInputOrderActionField *pStruct,
                                 CThostFtdcRspInfoField *pRspInfo,
                                 int nRequestID, bool bIsLast) {
  owner_->on_rsp_order_action(pStruct, pRspInfo, nRequestID, bIsLast);
}

void TraderSpi::OnRtnOrder(CThostFtdcOrderField *pStruct) {
  owner_->on_rtn_order(pStruct);
}

void TraderSpi::OnRtnTrade(CThostFtdcTradeField *pStruct) {
  owner_->on_rtn_trade(pStruct);
}
...
void MdSpi::OnFrontDisconnected(int nReason) {
  owner_->on_market_front_disconnected(nReason);
}

void MdSpi::OnRspUserLogin(CThostFtdcRspUserLoginField * /*pRspUserLogin*/,
                           CThostFtdcRspInfoField *pRspInfo, int /*nRequestID*/,
                           bool /*bIsLast*/) {
  owner_->on_market_login_rsp(pRspInfo);
}
...
void MdSpi::OnRspSubMarketData(
    ...
    CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {
  owner_->on_rsp_sub_market_data(pSpecificInstrument, pRspInfo, nRequestID,
                                 bIsLast, false);
}
...
void MdSpi::OnRtnDepthMarketData(CThostFtdcDepthMarketDataField *pData) {
  owner_->on_rtn_depth_market_data(pData);
}

PYBIND11_MODULE(ctp_bridge_native, m) {
  m.doc() = "CTP native bridge (pybind11)";

  py::class_<CtpClient>(m, "CtpClient")
      .def(py::init<>())
      .def("configure", &CtpClient::configure)
      .def("start", &CtpClient::start)
      .def("stop", &CtpClient::stop)
